...
class ProdutosRepo(FirestoreRepo):
    ...
    def create_produto(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return self.create(self.normalize_in(data))

    def update_produto(self, doc_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
